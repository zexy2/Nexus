...
async def run_test():
    ...
    try:
        ...
        # -> Verify the error message text and style for clarity and accessibility, then check layout consistency and responsiveness of the login form and error message.
        await page.mouse.wheel(0, await page.evaluate('() => window.innerHeight'))
        

        # -> Check layout consistency, spacing, alignment, and responsiveness of the login form and error message.
        await page.mouse.wheel(0, await page.evaluate('() => window.innerHeight'))
        ...
        # -> Test responsiveness by resizing or emulating different device screen sizes to ensure UI elements remain consistent and accessible.
        await page.mouse.wheel(0, await page.evaluate('() => window.innerHeight'))
